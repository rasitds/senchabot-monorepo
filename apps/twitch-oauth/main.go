...
var (
	...
	scopes       = []string{"chat:read", "chat:edit", "channel:moderate", "whispers:read", "whispers:edit", "channel_editor", "moderator:manage:shoutouts"}
...
func main() {
	...
	fmt.Println("TWITCH_CLIENT_ID:", os.Getenv("TWITCH_CLIENT_ID"))
